	...
	if(document.cadastro.nome.value=="")
		 ...
		 { alert("O Campo nome é obrigatório!");
		  ...
		  if(document.cadastro.email.value=="") 
					  ...
					  { alert("O Campo email é obrigatório!"); return false; } 

		  else 
			  if(document.cadastro.endereco.value=="") 

			  { alert("O Campo endereço é obrigatório!"); return false;
			  }
			  else 
					  ...
					  if(document.cadastro.estado.value=="") 
						  ...
						  if(document.cadastro.bairro.value=="") 
							  ...
							  if(document.cadastro.pais.value=="") 
								  { alert("O Campo país é obrigatório!"); return false; 
								  }
							   else 
								   if(document.cadastro.login.value=="") 
									   { alert("O Campo Login é obrigatório!"); return false; 
									   } 
								   else 
...
<tr><td><center><b>EEEP DAVID VIEIRA DA SILVA</b></center></td></tr>
<tr><td><center><b>CURSO TÉCNICO EM INFORMÁTICA</b></center></td></tr>
...
<form name="cadastro" method="post" action="index.php"  onsubmit="return validaCampo(); return false;">
